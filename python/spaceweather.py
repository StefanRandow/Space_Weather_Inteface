...
def main():
    ...
    report_section = tk.Text(window, state='normal', width = 80, height = 20)
    report_section.grid(row=2, column=0, sticky='nsew', padx=10, pady=10)
